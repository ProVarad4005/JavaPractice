...
public class Challenge2 {
	...
	{
		throw  new  ArithmeticException ("Error Occur While Connecting");
	}
public static void main(String[] args) 
      {
            try {
            	...
            	connectToServer();// to catch the exception thrown by connectto server we need to make new catch block as excp
            }catch(Exception e) 
            {
            	System.out.println(e);
            }
